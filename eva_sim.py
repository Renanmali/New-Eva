...
frame_memory.place(x=938, y=10)

# define o frame para o menu de botões
frame_botoes = tkinter.Frame(master=frame_centro)
frame_botoes.pack(pady=15, padx=10)

#define o frame para o checkbox
frame_chk = tkinter.Frame(master=frame_memory)
frame_chk.pack(pady=15)
...
# Váriaveis inicializadas para os botões
chk_voice_value = IntVar()
chk_handpose_value = IntVar()
chk_emotion_value = IntVar()
...
chk_voice = Checkbutton (frame_chk, text="Voice", variable=chk_voice_value, onvalue= 1, offvalue=0)
chk_voice.pack(side=tkinter.LEFT, padx=bt_padx)
chk_handpose = Checkbutton (frame_chk, text="Handpose", variable=chk_handpose_value, onvalue= 1, offvalue=0)
chk_handpose.pack(side=tkinter.LEFT, padx=bt_padx)
chk_emotion = Checkbutton (frame_chk, text="Emotion", variable=chk_emotion_value, onvalue= 1, offvalue=0)
chk_emotion.pack(side=tkinter.LEFT, padx=bt_padx)
